...
import moneyssImage from "./photos1/moneyys.png"; 
...
const Container = styled.div` 
  ...
  width: 600px; 
  max-width: 100%; 
  background-image: url(${moneyssImage});
  padding: 30px 20px; 
...
const Tracker = () => { 
  ...
  return ( 
    <Container> 
        <THeading>"Track your expenses today, secure your financial tomorrow."</THeading> 
